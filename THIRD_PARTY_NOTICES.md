...
- [tModLoader Terraria NPC/Player/Projectile patches](https://github.com/tModLoader/tModLoader/tree/1.4.4/patches/tModLoader/Terraria) — current `AddBuff`, hit-effect, projectile-status, and DoT update hooks used for authoritative DoT accounting.
...
The mod icon and Workshop thumbnail are derived from artwork supplied by the project owner for use in this mod. They are not covered by the project's GPL-3.0-only license; contact the project owner before reusing them outside Daybreak DamageTracker.
